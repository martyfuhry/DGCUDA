    ...
    for (n = 0; n < local_N; n++) {
        ...
        for (i = 0; i < local_num_elem; i++) {
            fprintf(out_file, "ST (%.015lf,%.015lf,0,%.015lf,%.015lf,0,%.015lf,%.015lf,0) {%.015lf,%.015lf,%.015lf};\n", 
                                   d_V1x[i], d_V1y[i], d_V2x[i], d_V2y[i], d_V3x[i], d_V3y[i],
...
void init_cpu(int local_num_elem, int local_num_sides, int local_n_p,
              double *V1x, double *V1y, 
              double *V2x, double *V2y, 
              double *V3x, double *V3y, 
              int *left_side_number, int *right_side_number,
    ...
    // allocate
    d_c = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));
    d_rhs_volume = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));
    d_rhs_surface_left = (double *)malloc(local_N * local_num_sides * local_n_p * sizeof(double));
    d_rhs_surface_right = (double *)malloc(local_N * local_num_sides * local_n_p * sizeof(double));

    d_k1 = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));
    d_k2 = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));
    d_k3 = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));
    d_k4 = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));

    d_J = (double *)malloc(local_num_elem * sizeof(double));
    d_lambda = (double *)malloc(local_num_elem * sizeof(double));
    d_s_length = (double *)malloc(local_num_sides * sizeof(double));

    d_s_V1x = (double *)malloc(local_num_sides * sizeof(double));
    d_s_V2x = (double *)malloc(local_num_sides * sizeof(double));
    d_s_V1y = (double *)malloc(local_num_sides * sizeof(double));
    d_s_V2y = (double *)malloc(local_num_sides * sizeof(double));

    d_elem_s1 = (int *)malloc(local_num_elem * sizeof(int));
    d_elem_s2 = (int *)malloc(local_num_elem * sizeof(int));
    d_elem_s3 = (int *)malloc(local_num_elem * sizeof(int));

    d_Uv1 = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));
    d_Uv2 = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));
    d_Uv3 = (double *)malloc(local_N * local_num_elem * local_n_p * sizeof(double));

    d_V1x = (double *)malloc(local_num_elem * sizeof(double));
    d_V1y = (double *)malloc(local_num_elem * sizeof(double));
    d_V2x = (double *)malloc(local_num_elem * sizeof(double));
    d_V2y = (double *)malloc(local_num_elem * sizeof(double));
    d_V3x = (double *)malloc(local_num_elem * sizeof(double));
    d_V3y = (double *)malloc(local_num_elem * sizeof(double));

    d_xr = (double *)malloc(local_num_elem * sizeof(double));
    d_yr = (double *)malloc(local_num_elem * sizeof(double));
    d_xs = (double *)malloc(local_num_elem * sizeof(double));
    d_ys = (double *)malloc(local_num_elem * sizeof(double));

    d_left_side_number = (int *)malloc(local_num_sides * sizeof(int));
    d_right_side_number = (int *)malloc(local_num_sides * sizeof(int));

    d_Nx = (double *)malloc(local_num_sides * sizeof(double));
    d_Ny = (double *)malloc(local_num_sides * sizeof(double));

    d_left_elem = (int *)malloc(local_num_sides * sizeof(int));
    d_right_elem = (int *)malloc(local_num_sides * sizeof(int));

    // copy over data
    memcpy(d_s_V1x, sides_x1, local_num_sides * sizeof(double));
    memcpy(d_s_V1y, sides_y1, local_num_sides * sizeof(double));
    memcpy(d_s_V2x, sides_x2, local_num_sides * sizeof(double));
    memcpy(d_s_V2y, sides_y2, local_num_sides * sizeof(double));

    memcpy(d_left_side_number , left_side_number , local_num_sides * sizeof(int));
    memcpy(d_right_side_number, right_side_number, local_num_sides * sizeof(int));

    memcpy(d_elem_s1, elem_s1, local_num_elem * sizeof(int));
    memcpy(d_elem_s2, elem_s2, local_num_elem * sizeof(int));
    memcpy(d_elem_s3, elem_s3, local_num_elem * sizeof(int));

    memcpy(d_V1x, V1x, local_num_elem * sizeof(double));
    memcpy(d_V1y, V1y, local_num_elem * sizeof(double));
    memcpy(d_V2x, V2x, local_num_elem * sizeof(double));
    memcpy(d_V2y, V2y, local_num_elem * sizeof(double));
    memcpy(d_V3x, V3x, local_num_elem * sizeof(double));
    memcpy(d_V3y, V3y, local_num_elem * sizeof(double));

    memcpy(d_left_elem , left_elem , local_num_sides * sizeof(int));
    memcpy(d_right_elem, right_elem, local_num_sides * sizeof(int));
}
